    ...
    <div class="bg-white rounded-xl shadow-lg p-4 glass-effect">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('inventory.template.supply') }}"
        ...
        <div id="form-manual" class="tab-content">
            <form action="{{ route('inventory.import.supply') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Mã vật tư <span
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Tên vật tư <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Đơn vị tính <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Chiều dài mỗi cây <span
                                class="text-red-500">*</span></label>
                        <input type="number" name="length_per_tree" id="length_per_tree"
                            value="{{ old('length_per_tree') }}" required
                            class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            placeholder="50" min="0" step="0.01">
                        <p class="text-xs text-gray-500 mt-1">Chiều dài của mỗi cây (VD: 50 cm)</p>
                    </div>
                    <div id="tree_count_field">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Số lượng cây <span
                                class="text-red-500">*</span></label>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <div class="mt-3 p-2 bg-green-50 border border-green-200 rounded">
                    <p class="text-xs text-green-800"><i class="fas fa-lightbulb mr-1"></i><strong>Mẹo:</strong> Đặt tên ảnh
                        theo mã vật tư (VT001.jpg, VT002.png...) rồi chọn tất cả ảnh cùng lúc khi upload!</p>
                </div>
            </div>

            <form action="{{ route('inventory.import.supply.excel') }}" method="POST" enctype="multipart/form-data" id="supply-excel-form">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <input type="file" name="images[]" id="supply-image-files"
                    ...
                    <div class="mt-2 text-xs text-blue-700">
                        ...
                        <ul class="list-disc list-inside space-y-1 ml-2">
                            <li>Đặt tên ảnh theo mã vật tư: <code class="bg-blue-100 px-1 rounded">VT001.jpg</code>, <code
                                    class="bg-blue-100 px-1 rounded">VT002.png</code></li>
...
@push('scripts')
    <script>
        ...
        // Image files preview cho Excel import with 200 file limit warning and submit control
        (() => {
            const imageInput = document.getElementById('supply-image-files');
            const preview = document.getElementById('supply-image-preview');
            const form = document.getElementById('supply-excel-form');
            const submitBtn = document.getElementById('supply-submit-btn');
            if (!imageInput || !preview || !form || !submitBtn) return;
