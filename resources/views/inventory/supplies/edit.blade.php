...
<div class="bg-white rounded-xl shadow-lg p-4 glass-effect">
    ...
    <form action="{{ route('inventory.supplies.update', $supply->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Chiều dài <span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                @if($supply->image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $supply->image) }}" alt="{{ $supply->name }}" 
                            class="max-w-32 max-h-32 object-contain rounded border bg-gray-100 cursor-pointer"
                            onclick="showFullImage(this.src, '{{ $supply->name }}')"
