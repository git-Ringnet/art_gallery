            ...
            <div class="relative top-20 mx-auto p-6 border w-full max-w-2xl shadow-2xl rounded-xl bg-white">
                <div class="mt-2">
                    ...
                    <form id="dataScopeForm">
                        ...
                        <!-- Phạm vi sửa/xóa -->
                        <div id="edit-scope-section" class="mb-4">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-edit mr-1"></i>Phạm vi sửa/xóa dữ liệu
                            </label>
                            <select id="edit-scope-select" name="edit_scope" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                                <option value="all">Theo phạm vi dữ liệu ở trên</option>
                                <option value="own">Chỉ được sửa/xóa dữ liệu của chính mình</option>
                            </select>
                            <p class="text-xs text-gray-500 mt-1">
                                <i class="fas fa-info-circle"></i> 
                                Kiểm soát người dùng có thể sửa/xóa những đơn hàng nào
                            </p>
                        </div>
