                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                    <div>
                        ...
                        <input type="text" name="exchange_rate" id="rate" required
                            ...
                            oninput="calcTotalPaid(); calcDebt()" onchange="calc()">
                    ...
                    <div id="discount-usd-section" class="{{ $sale->discount_amount_usd > 0 ? '' : 'hidden' }}">
                    ...
                    <div id="discount-vnd-section" class="{{ $sale->discount_amount_vnd > 0 ? '' : 'hidden' }}">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function calc() {
                ...
                document.getElementById('total_vnd').value = totalVnd.toLocaleString('vi-VN') + 'đ';
