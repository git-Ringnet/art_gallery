...
<head>
    ...
    <title>Đặt lại mật khẩu - Hệ thống Quản lý Tranh</title>
...
<body class="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-2">Đặt lại mật khẩu</h2>
            <p class="text-center text-gray-600 mb-8">Nhập mật khẩu mới của bạn</p>
