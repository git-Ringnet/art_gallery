    ...
    public function model(array $row)
    {
        try {
            ...
            $paintingData = [
                ...
                'width' => !empty($normalizedRow['chieu_rong_cm']) ? round((float)$normalizedRow['chieu_rong_cm'], 2) : null,
                'height' => !empty($normalizedRow['chieu_cao_cm']) ? round((float)$normalizedRow['chieu_cao_cm'], 2) : null,
                'depth' => !empty($normalizedRow['chieu_sau_cm']) ? round((float)$normalizedRow['chieu_sau_cm'], 2) : null,
                'paint_year' => $normalizedRow['nam_ve'] ?? null,
                'price_usd' => !empty($normalizedRow['gia_usd']) ? round((float)$normalizedRow['gia_usd'], 2) : 0,
                'price_vnd' => null,
                'image' => $imagePath,
                'quantity' => 1,
